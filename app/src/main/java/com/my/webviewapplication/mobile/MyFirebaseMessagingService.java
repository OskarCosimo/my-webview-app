...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private static final String CHANNEL_ID = "myetv_notifications";
    ...
    public void onNewToken(@NonNull String token) {
        ...
        // Send updated token to your backend server if required
        sendTokenToServer(token);
    }

    /**
     * Helper method to process or transmit the updated FCM token to your backend
     *
     * @param token The new Firebase Messaging token
     */
    private void sendTokenToServer(String token) {
        // Handle token synchronization with server if needed
    }
